...
Public Class frmMain
    ...
    Private Sub frmMain_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        ' Shows numbers 0 through 10 in the ComboBox
    ...
    Private Sub cboAllowances_TextChanged(sender As Object, e As EventArgs) _
        ...
        ' If any of the above things change, it will clear the table until you hit calculate again
    ...
    Private Sub frmMain_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
        ' Verify that the use wants to exit the application.
